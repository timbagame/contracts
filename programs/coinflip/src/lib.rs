...
declare_id!("DNAGhpeMXvdCkwTYKmuJfcwpu4sJpegcnHnHih1Y3Gzi");
...
pub mod coinflip {
    ...
    pub fn initialize_token(
        ...
        instructions::initialize_token::handler(ctx, min_amount, enabled)
    }
    ...
    pub fn update_token(
        ...
        instructions::update_token::handler(ctx, min_amount, enabled)
    }
