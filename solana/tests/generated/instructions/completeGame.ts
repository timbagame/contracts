...
export type CompleteGameInstruction<
  ...
  TAccountOracleOperatorTokenAccount extends string | AccountMeta<string> = string,
  ...
  InstructionWithAccounts<
    [
      ...
      TAccountOracleOperator extends string
        ? ReadonlySignerAccount<TAccountOracleOperator> & AccountSignerMeta<TAccountOracleOperator>
...
export type CompleteGameAsyncInput<
  ...
  TAccountGameVaultTokenAccount extends InstructionAccountInput = InstructionAccountInput,
  ...
  TAccountWinnerTokenAccount extends InstructionAccountInput = InstructionAccountInput,
  TAccountOracleOperatorTokenAccount extends InstructionAccountInput = InstructionAccountInput,
> = {
  game?: TAccountGame;
...
>(
  ...
  CompleteGameInstruction<
    TProgramAddress,
    ResolvedInstructionAccountMeta<TAccountGame, InstructionAccountInputAddress<TAccountGame>>,
    ...
    >,
    ResolvedInstructionAccountMeta<TAccountWinner, InstructionAccountInputAddress<TAccountWinner>>,
    ResolvedInstructionAccountMeta<
      TAccountCreator,
...
> {
  ...
  const originalAccounts = {
    ...
    gameVault: { value: input.gameVault ?? null, isSigner: false, isWritable: false },
    ...
    oracleOperator: { value: input.oracleOperator ?? null, isSigner: true, isWritable: false },
    ...
    accounts.gameVaultTokenAccount.value = await getProgramDerivedAddress({
      ...
      seeds: [
        getAddressEncoder().encode(
          getAddressFromResolvedInstructionAccount("gameVault", accounts.gameVault.value),
        ),
        getAddressEncoder().encode(
          getAddressFromResolvedInstructionAccount("tokenProgram", accounts.tokenProgram.value),
        ),
        getAddressEncoder().encode(
          getAddressFromResolvedInstructionAccount("tokenMint", accounts.tokenMint.value),
        ),
      ],
    });
  }
  ...
  return Object.freeze({
    ...
    data: getCompleteGameInstructionDataEncoder().encode(args as CompleteGameInstructionDataArgs),
    programAddress,
